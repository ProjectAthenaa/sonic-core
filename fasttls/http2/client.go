...
func (cl *Client) CreateDo(cs *ClientSettings) func(req *fasthttp.Request, res *fasthttp.Response) (err error) {
	return func(req *fasthttp.Request, res *fasthttp.Response) (err error) {
		var c *Conn
