...
func HasShippingAddress() predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, ShippingAddressTable, ShippingAddressPrimaryKey...),
		)
...
func HasBillingAddress() predicate.Address {
	return predicate.Address(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, true, BillingAddressTable, BillingAddressPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
