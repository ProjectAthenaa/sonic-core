...
func ID(id int) predicate.Shipping {
...
func IDEQ(id int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
...
func HasShippingAddress() predicate.Shipping {
	return predicate.Shipping(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, ShippingAddressTable, ShippingAddressPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
