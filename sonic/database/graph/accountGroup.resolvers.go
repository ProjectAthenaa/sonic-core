...
func (r *mutationResolver) DeleteAccountGroup(ctx context.Context, accountGroupID string) (bool, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *queryResolver) GetAccountGroup(ctx context.Context, accountGroupID string) (*ent.AccountGroup, error) {
	panic(fmt.Errorf("not implemented"))
}
