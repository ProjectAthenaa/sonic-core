...
func (c *monitorClient) Stop(ctx context.Context, in *Key, opts ...grpc.CallOption) (*BoolResponse, error) {
	out := new(BoolResponse)
	err := c.cc.Invoke(ctx, "/monitor_controller.Monitor/Stop", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Monitor_NewTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Task)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MonitorServer).NewTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/monitor_controller.Monitor/NewTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MonitorServer).NewTask(ctx, req.(*Task))
	}
	return interceptor(ctx, in, info, handler)
}

func _Monitor_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Key)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MonitorServer).Stop(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/monitor_controller.Monitor/Stop",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MonitorServer).Stop(ctx, req.(*Key))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Monitor_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "monitor_controller.Monitor",
	HandlerType: (*MonitorServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NewTask",
			Handler:    _Monitor_NewTask_Handler,
		},
		{
			MethodName: "Stop",
			Handler:    _Monitor_Stop_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "MonitorController.proto",
}
